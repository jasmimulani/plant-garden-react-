        ...
        <section>
          <div className='row pt-[120px] pb-[120px] flex max-lg:block max-lg:py-[50px] max-md:py-[40px]'>
            <div className='col col-xl-4 pr-[6%] max-lg:pb-[25px]'>
              <ul>
                <h1 className='mb-[35px] text-[22px] font-semibold '>Newletter</h1>
                <p className='mb-[40px]'> Get Free 20% disount for all products on your first order</p>

                <div className='flex'>
                  <input type='email' placeholder='Your Email' className='outline-one text-[15px] w-[100%] ps-[17px] py-[10px] bg-[#E7E7E7]' />
            ...
            <div className='col col-xl-8 flex max-md:block'>
              <div className='col pr-[10%] max-lg:mt-[30px] max-md-w-auto'>
                <ul>
                  <h1 className='mb-[35px] text-[22px] font-semibold'> Quick contact</h1>
                  <p className='mb-[40px]'> 121 King St, Melbourne VIC 3000,Australia</p>
                  <div>
                    <div className=' border-1 border-[#8581AC] rounded-3xl flex py-[14px] px-[20px] items-center tracking-widest'>
                      <span className='mr-[14px]'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 23 23" fill="none"><path d="M17.8887 1L21.8887 5L17.8887 9" stroke="#B23E24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M13.8887 5H21.8887" stroke="#B23E24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M20.8881 16.9201V19.9201C20.8892 20.1986 20.8322 20.4743 20.7206 20.7294C20.6091 20.9846 20.4454 21.2137 20.2402 21.402C20.035 21.5902 19.7927 21.7336 19.5289 21.8228C19.265 21.912 18.9855 21.9452 18.7081 21.9201C15.631 21.5857 12.6751 20.5342 10.0781 18.8501C7.66194 17.3148 5.61345 15.2663 4.07812 12.8501C2.38809 10.2413 1.33636 7.27109 1.00812 4.1801C0.983127 3.90356 1.01599 3.62486 1.10462 3.36172C1.19324 3.09859 1.33569 2.85679 1.52288 2.65172C1.71008 2.44665 1.93792 2.28281 2.19191 2.17062C2.44589 2.05843 2.72046 2.00036 2.99812 2.0001H5.99812C6.48342 1.99532 6.95391 2.16718 7.32188 2.48363C7.68985 2.80008 7.93019 3.23954 7.99812 3.7201C8.12474 4.68016 8.35957 5.62282 8.69812 6.5301C8.83266 6.88802 8.86178 7.27701 8.78202 7.65098C8.70227 8.02494 8.51698 8.36821 8.24812 8.6401L6.97812 9.9101C8.40167 12.4136 10.4746 14.4865 12.9781 15.9101L14.2481 14.6401C14.52 14.3712 14.8633 14.1859 15.2372 14.1062C15.6112 14.0264 16.0002 14.0556 16.3581 14.1901C17.2654 14.5286 18.2081 14.7635 19.1681 14.8901C19.6539 14.9586 20.0975 15.2033 20.4146 15.5776C20.7318 15.9519 20.9003 16.4297 20.8881 16.9201Z" stroke="#B23E24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                      </span>
              ...
              <div className='col max-lg:mt-[30px] max-md-w-auto'>
                <ul>
                  <h1 className='mb-[35px] text-[22px] font-semibold'>Follow us</h1>
                  <div className='flex'>
              ...
              <div>
                ...
                <div className='flex max-sm:py-1 max-md:justify-start max-md:mt-[15px]'>
                  <div className='flex justify-end'>
                    <span className='text-base text-gray-500'>Designed by:
                      <span className='font-bold'>Wpignite</span>
                    </span>
                  </div>
                </div>
          </div>
