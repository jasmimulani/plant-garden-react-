...
const validationSchema = yup.object({
    firstname: yup.string().required("fill out this field."),
    email: yup.string().email('invalid address...').required(" fill out this field."),
    phone: yup.string().required(" fill out this field."),
    Message: yup.string().required(" fill out this field."),
})
...
const Contact_Two = () => {
    ...
    <Container>
                <section className='flex justify-between max-xl:block '>
                    ...
                    <div className='w-[47%] max-xl:w-auto flex justify-center'>
